...
PATRONI_MINIMUM_SYNCHRONOUS_REPLICAS=${PATRONI_MINIMUM_SYNCHRONOUS_REPLICAS:-1}
...
sed -e "s/__MY_NAME__/$MY_NAME/g" \
    ...
    -e "s/__MINIMUM_SYNCHRONOUS_REPLICAS__/$PATRONI_MINIMUM_SYNCHRONOUS_REPLICAS/g" \
...
PATRONI_MINIMUM_SYNCHRONOUS_REPLICAS=$PATRONI_MINIMUM_SYNCHRONOUS_REPLICAS
APP_NAME=$APP_NAME
